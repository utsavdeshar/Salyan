...
try {
    ...
    var adDateObj = { 
      year: parseInt(splitedAD[2]),
      month: parseInt(splitedAD[1]),
      day: parseInt(splitedAD[0])
  };
    convertedDate = NepaliFunctions.AD2BS(adDateObj);
    bsDate = convertedDate.year + "-" + convertedDate.month + "-" + convertedDate.day;
    // alert(bsDate)
