...
FROM
    (SELECT 'Acne' AS answer_name 
     UNION SELECT 'Warts' 
     UNION SELECT 'Chloasma/ melasma'
     UNION SELECT 'Urticaria'
     UNION SELECT 'Dermatitis/Eczema'
     UNION SELECT 'Alopecia'
     UNION SELECT 'Cellulitis'
     UNION SELECT 'Pediculosis (Lice)'
     UNION SELECT 'Vitiligo'
     UNION SELECT 'Albinism'
     UNION SELECT 'Herpes simplex'
     UNION SELECT 'Herpes zoster'
     UNION SELECT 'Erythroderma'
     UNION SELECT 'Impetigo'
     UNION SELECT 'Boils'
     UNION SELECT 'Abscess'
     UNION SELECT 'Furunculosis'
     UNION SELECT 'Fungal infection (lichen planus)'
     UNION SELECT 'Scabies'
     UNION SELECT 'Leukoplakia'
     UNION SELECT 'Psoriasis'
     UNION SELECT 'Acute Lymphadenitis'
     UNION SELECT 'Frostbite') first_answers
    LEFT JOIN
    (SELECT DISTINCT
    ...
    WHERE hdm.hmis IN (
        'Acne', 'Warts', 'Chloasma/ melasma', 'Urticaria', 'Dermatitis/Eczema', 
        'Alopecia', 'Cellulitis', 'Pediculosis (Lice)', 'Vitiligo', 'Albinism', 
        'Herpes simplex', 'Herpes zoster', 'Erythroderma', 'Impetigo', 'Boils', 
        'Abscess','Furunculosis','Fungal infection (lichen planus)', 'Scabies', 'Leukoplakia', 'Psoriasis', 
        'Acute Lymphadenitis', 'Frostbite')) raw_data_final 
