...
FROM
    (SELECT 'Ectopic pregnancy' AS answer_name 
     UNION SELECT 'Abortion Complication'
     UNION SELECT 'Pregnancy-induced hypertension (PIH)'
     UNION SELECT 'Severe/ Pre-eclampsia'
     UNION SELECT 'Antepartum eclampsia'
     UNION SELECT 'Intrapartum eclampsia'
     UNION SELECT 'Postpartum eclampsia'
     UNION SELECT 'Hyperemesis gravidarum'
     UNION SELECT 'Antepartum haemorrhage'
     UNION SELECT 'Prolonged labour'
     UNION SELECT 'Obstructed labour'
     UNION SELECT 'Ruptured uterus'
     UNION SELECT 'Postpartum haemorrhage'
     UNION SELECT 'Retained placenta'
     UNION SELECT 'Other complications of labor and delivery'
     UNION SELECT 'Puerperal sepsis') first_answers
    LEFT JOIN
    (SELECT DISTINCT
    ...
    WHERE hdm.hmis IN (
        'Ectopic pregnancy', 'Abortion Complication','Pregnancy-induced hypertension (PIH)', 'Severe/ Pre-eclampsia', 
        ...
        'Obstructed labour', 'Ruptured uterus', 'Postpartum haemorrhage', 
        'Retained placenta', 'Other complications of labor and delivery', 
        'Puerperal sepsis')) raw_data_final 
