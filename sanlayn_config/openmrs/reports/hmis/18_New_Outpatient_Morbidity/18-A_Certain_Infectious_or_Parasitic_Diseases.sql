...
FROM
    (SELECT 'Measles' AS answer_name UNION SELECT 'Diphtheria' AS answer_name UNION SELECT 'Whooping cough' AS answer_name UNION SELECT 'Neonatal tetanus' AS answer_name UNION SELECT 'Tetanus' AS answer_name UNION SELECT 'Tuberculosis' AS answer_name UNION SELECT 'Rubella' AS answer_name UNION SELECT 'Chicken pox' AS answer_name UNION SELECT 'Hepatitis B' AS answer_name UNION SELECT 'Acute Flaccid Paralysis (AFP)' AS answer_name UNION SELECT 'Mumps' AS answer_name) first_answers
        LEFT JOIN
    (SELECT DISTINCT
    ...
    WHERE
        hdm.hmis IN ('Measles' , 'Diphtheria', 'Whooping cough', 'Neonatal tetanus', 'Tetanus', 'Tuberculosis', 'Rubella', 'Mumps', 'Chicken pox', 'Hepatitis B')) raw_data_final ON first_answers.answer_name = raw_data_final.hmis
