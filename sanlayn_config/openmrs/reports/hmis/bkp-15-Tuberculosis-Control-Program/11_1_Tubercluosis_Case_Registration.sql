...
ORDER BY Field(first_answers.answer_name,'Pulmonary BC','Pulmonary CD','Extra Pulmonary'),field(second_answers.answer_name,'New Diagnosis','Relapse','Treatment after failure','Treatment after loss to follow-up','Other previously treated','Previous treatment history unknown'),field(gender.gender,'F','M');
