...
class nepali_date
{
	...
	private $nepali_length = array(
		...
		2082 => array(31, 31, 32, 31, 31, 31, 30, 29, 30, 29, 30, 30),
...
function convertToNepaliFont($date)
{
    // Nepali digits mapping (for 0-9)
    $nepaliDigits = array(
        '0' => '०',
        '1' => '१',
        '2' => '२',
    ...
    // Convert Gregorian digits to Nepali digits
    $convertedDate = str_replace(array_keys($nepaliDigits), array_values($nepaliDigits), $date);
